    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    @endif
                        En este momento se encuentra logueado con el cargo de Jefe de Departamento, a continuacion se muestra las opciones que usted tiene
                </div>
                <br>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-4">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title"><strong>Materias</strong></h5>
                        <p class="card-text">Aqui puede elegir la materia de la que quiera llenar un reporte.</p>
                        <a href="{{ url('/usuario') }}" class="btn btn-primary">Ir a Materias</a>
                    </div>
                </div>
            </div>
            <div class="col-sm-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="{{ url('/reporteDocAsistencia') }}" class="btn btn-primary">Ir a Reporte</a>
                    </div>
                </div>
            </div>
            <div class="col-sm-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="{{ url('/reporteDocDpaUti') }}" class="btn btn-primary">Ir a Reportes</a>
                    </div>
                </div>
            </div>
            <div class="col-sm-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="{{ url('/reporteDocResumen') }}" class="btn btn-primary">Ir a Reporte</a>
                    </div>
                </div>
            </div>
        </div>
