  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('jefeDepartamento.home') }}" class="nav-link">Home</a> <!-- href="{{ route('welcome') }}" -->
      </li>
    </ul>
    <!-- SEARCH FORM 
    ...
    <div class="sidebar">
      ...
      <?php
          ...
          include($_SERVER['DOCUMENT_ROOT'].'../../resources/views/conexion.php');
            ...
            $query=pg_query($conexion,"SELECT materias.nombre FROM materias 
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">              
          <!-- Add icons to the links using the .nav-icon class-->
               ...
               <li class="nav-item has-treeview">
                  <a href="{{ url('/usuario') }}" class="nav-link"> <!-- class="btn btn-dark" -->
                    <i class="nav-icon fas fa-copy"></i>
                        <p>Materias</p>
                  </a>
                </li>
                <li class="nav-item has-treeview">
                  <a href="{{ url('/reporteDocAsistencia') }}" class="nav-link"> <!-- class="btn btn-dark" -->
                    <i class="nav-icon fas fa-copy"></i>
                        <p>Reporte de asistencias</p>
                  </a>
                </li>
                <li class="nav-item has-treeview">
                  <a href="{{ url('/reporteDocDpaUti') }}" class="nav-link"> <!-- class="btn btn-dark" -->
                    <i class="nav-icon fas fa-copy"></i>
                        <p>Reporte para DPA</p>
                  </a>
                </li>
                <li class="nav-item has-treeview">
                  <a href="{{ url('/reporteDocResumen') }}" class="nav-link"> <!-- class="btn btn-dark" -->
                    <i class="nav-icon fas fa-copy"></i>
                        <p>Reporte Resumen</p>
                  </a>
                </li>
