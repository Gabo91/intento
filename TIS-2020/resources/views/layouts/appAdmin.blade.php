  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('admin.home') }}" class="nav-link">Home</a> <!-- href="{{ route('welcome') }}" -->
      </li>
    </ul>
    <!-- SEARCH FORM 
          ...
          <!-- Add icons to the links using the .nav-icon class-->
               <!--with font-awesome or any other icon font library -->
                <li class="nav-item has-treeview">
                  <!-- <a href="{{ url('/register') }}" class="nav-link"> class="btn btn-dark" -->
                  <a href="{{ route('admin.usuarios') }}" class="nav-link"> <!-- class="btn btn-dark" -->
                    <i class="nav-icon fas fa-copy"></i>
                        <p>Usuarios</p>
                  </a>
                </li>
                <li class="nav-item has-treeview">
                  <a href="{{ route('admin.unidades') }}" class="nav-link"> <!-- class="btn btn-dark" -->
                    <i class="nav-icon fas fa-copy"></i>
                        <p>Registro de Unidades</p>
                  </a>
                </li>
                <li class="nav-item has-treeview">
                  <a href="{{ url('/registrarMaterias') }}" class="nav-link"> <!-- route('admin.materias')//class="btn btn-dark" -->
                    <i class="nav-icon fas fa-copy"></i>
                        <p>Registro de Materias</p>
                  </a>
                </li>
                <li class="nav-item has-treeview">
                  <a href="{{ route('admin.herramientas') }}" class="nav-link"> <!-- class="btn btn-dark" -->
                    <i class="nav-icon fas fa-copy"></i>
